...
<table class="table table-bordered table-condensed">
				<thead>
					<tr>
						<th>序号</th>
						<th>会议简称</th>
						<th class="fullname">会议全称</th>
						<th>分类</th>
						<th>类型</th>
						<th class="field">专业领域</th>
					</tr>
				</thead>
				<tbody>					
        <tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">1</th>
						<td>SoCC</td>
					...
					<tr class="item" style="background-color:OldLace">
						<th scope="row">1</th>
						<td>CF</td>
						...
						<td>会议</td>
						<td>计算机体系结构/并行与分布计算/存储系统</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						<th scope="row">2</th>
						<td>SYSTOR</td>
						...
						<th scope="row">26</th>
						<td>ITC-Asia</td>
						<td>International Test Conference in Asia</td>
						<td>C</td>
						<td>会议</td>
						<td>计算机体系结构/并行与分布计算/存储系统</td>
					</tr>					<tr class="item" style="background-color:Wheat">
						<th scope="row">1</th>
						<td>SIGCOMM</td>
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">20</th>
						<td>APNet</td>
						<td>Asia-Pacific Workshop on Networking</td>
						<td>C</td>
						<td>会议</td>
						<td>计算机网络</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">8</th>
						<td>CT-RSA</td>
						<td>Cryptographer&rsquo;s Track at RSA Conference</td>
						<td>C</td>
						<td>会议</td>
						<td>网络与信息安全</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">25</th>
						<td>EuroS&amp;P</td>
						<td>IEEE European Symposium on Security and Privacy</td>
						<td>C</td>
						<td>会议</td>
						<td>网络与信息安全</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						<th scope="row">26</th>
						<td>Inscrypt</td>
						<td>International Conference on Information Security and Cryptology</td>
						<td>C</td>
						<td>会议</td>
						<td>网络与信息安全</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">4</th>
						<td>RE</td>
						<td>IEEE International Requirement Engineering Conference</td>
						<td>B</td>
						<td>会议</td>
						<td>软件工程/系统软件/程序设计语言</td>
					</tr>
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">13</th>
						<td>QSIC</td>
						<td>International Conference on Quality Software</td>
						<td>C</td>
						<td>会议</td>
						<td>软件工程/系统软件/程序设计语言</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">26</th>
						<td>Internetware</td>
						<td>Asia-Pacific Symposium on Internetware</td>
						<td>C</td>
						<td>会议</td>
						<td>软件工程/系统软件/程序设计语言</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						<th scope="row">27</th>
						<td>RV</td>
						<td>International Conference on Runtime Verification</td>
						<td>C</td>
						<td>会议</td>
						<td>软件工程/系统软件/程序设计语言</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">12</th>
						<td>RecSys</td>
						<td>ACM Conference on Recommender Systems</td>
						<td>B</td>
						<td>会议</td>
						<td>数据库/数据挖掘/内容检索</td>
					</tr>
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">12</th>
						<td>ADMA</td>
						<td>International Conference on Advanced Data Mining and Applications</td>
						<td>C</td>
						<td>会议</td>
						<td>数据库/数据挖掘/内容检索</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">9</th>
						<td>COCOON</td>
						<td>International Computing and Combinatorics Conference</td>
						<td>B</td>
						<td>会议</td>
						<td>计算机科学理论</td>
					</tr>
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">11</th>
						<td>SETTA</td>
						<td>International Symposium on Dependable Software Engineering: Theories, Tools, and Applications</td>
						<td>C</td>
						<td>会议</td>
						<td>计算机科学理论</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">13</th>
						<td>ICVRV</td>
						<td>International Conference on Virtual Reality and Visualization</td>
						<td>C</td>
						<td>会议</td>
						<td>计算机图形学与多媒体</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">15</th>
						<td>PRCV</td>
						<td>Chinese Conference on Pattern Recognition and Computer Vision (中国模式识别与计算机视觉大会)</td>
						<td>C</td>
						<td>会议</td>
						<td>计算机图形学与多媒体</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">5</th>
						<td>NLPCC</td>
						<td>conf.International Conference on Natural Language Processing and Chinese Computing</td>
						<td>C</td>
						<td>会议</td>
						<td>人工智能</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">9</th>
						<td>IROS</td>
						<td>IEEE/RSJ International Conference on Intelligent Robots and Systems</td>
						<td>C</td>
						<td>会议</td>
						<td>人工智能</td>
					</tr>					<tr class="item" style="background-color:OldLace">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">7</th>
						<td>ICWSM</td>
						<td>The International AAAI Conference on Web and Social Media</td>
						<td>B</td>
						<td>会议</td>
						<td>人机交互与普适计算</td>
					</tr>
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">6</th>
						<td>MICCAI</td>
						<td>International Conference on Medical Image Computing and Computer-Assisted Intervention</td>
						<td>B</td>
						<td>会议</td>
						<td>交叉/综合/新兴</td>
					</tr>
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">8</th>
						<td>SAGT</td>
						<td>International Symposium on Algorithmic Game Theory</td>
						<td>C</td>
						<td>会议</td>
						<td>交叉/综合/新兴</td>
					</tr>					<tr class="item" style="background-color:OldLace">
						<th scope="row">9</th>
						<td>SIGSPATIAL</td>
						<td>ACM Special Interest Group on Spatial Information</td>
						<td>C</td>
						<td>会议</td>
						<td>交叉/综合/新兴</td>
					</tr>					<tr class="item" style="background-color:OldLace">
	...
	</div>	<div class="hideable" id="ccf">
		<header class="hide-head nowrap">
			<h2>中国计算机学会推荐国际学术期刊</h2>
		</header>
		<div class="hide-body">
			<table class="table table-bordered table-condensed">
				<thead>
					<tr>
						<th>序号</th>
						<th>刊物简称</th>
						<th class="fullname">刊物全称</th>
						<th>分类</th>
						<th>类型</th>
						<th class="field">专业领域</th>
					</tr>
				</thead>
				<tbody>					<tr class="item" style="background-color:Wheat">
						<th scope="row">1</th>
						<td>TOCS</td>
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">13</th>
						<td>TSUSC</td>
						<td>IEEE Transactions on Sustainable Computing</td>
						<td>C</td>
						<td>期刊</td>
						<td>计算机体系结构/并行与分布计算/存储系统</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:AntiqueWhite">
						<th scope="row">1</th>
						<td>TISSEC</td>
						<td>ACM Transactions on Information and System Security</td>
						<td>B</td>
						<td>期刊</td>
						<td>网络与信息安全</td>
					</tr>
					...
					<tr class="item" style="background-color:OldLace">
						<th scope="row">1</th>
						<td>TALIP</td>
						<td>ACM Transactions on Asian Language Information Processing</td>
						<td>C</td>
						<td>期刊</td>
						<td>人工智能</td>
					</tr>					<tr class="item" style="background-color:OldLace">
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">4</th>
						<td>PACMHCI</td>
						<td>Proceedings of the ACM on HumanComputer Interaction</td>
						<td>C</td>
						<td>期刊</td>
						<td>人机交互与普适计算</td>
					</tr>					<tr class="item" style="background-color:Wheat">
					...
					<tr class="item" style="background-color:OldLace">
						...
						<th scope="row">11</th>
						<td>TOCE</td>
						<td>ACM Transactions on Computing Education</td>
						<td>C</td>
						<td>期刊</td>
						<td>交叉/综合/新兴</td>
					</tr>					<tr class="item" style="background-color:OldLace">
